      ...
      <div className="min-h-screen bg-transparent pointer-events-none z-10 w-full fixed top-0">
        <div className="w-[70%] shadow fixed bottom-0 right-[10%] md:w-[40%] lg:w-[30%] xl:w-[20%] rounded-t-[20px] bg-white">
          <div className="bg-white">
            ...
            <div className="message-screen bg-white relative overflow-y-scroll hide-scrollbar h-[400px] p-4">
              {messages.map((msg) => (
                <div
                  key={msg.id}
            ...
            <div className="border-t border-gray-300 p-2 flex items-center">
              ...
              <input
                ...
                className="flex-1 ml-2 p-2 border rounded-full focus:outline-none"
