...
export default function BasicModal() {
  ...
  // New state variables for video functionality
  ...
  const handlePostUpload = async () => {
    const postData = {
      ...
      postVideo: await uploadVideo(), // Added video to post data
    };
  ...
  useEffect(() => {
    ...
    if (postSuccess) {
      ...
      setOpenColor(false);
      setOpen(false);
      setVideoSelected(false); // Reset video state on success
  ...
  // New function to upload video to Cloudinary
